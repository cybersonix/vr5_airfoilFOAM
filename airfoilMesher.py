...
firstLayerHeight = 0.0006  # Multiples Chord Length
growthRate = 1.05
...
ny17 = (0.001) / ((0.001) ** 2 + (
            np.interp(0.251, xBottom[::-1], yBottom[::-1]) - np.interp(0.25, xBottom[::-1], yBottom[::-1])) ** 2) ** 0.5
...
f.write('    hex (2 1 10 13 21 20 29 32) (' + str(NWake) + ' ' + str(NFF) + ' 1) simpleGrading (' + str(
    TopWakeGrading) + ' ' + str(WakeGrading) + ' ' + str(WakeGrading) + ' ' + str(TopWakeGrading) + ' ' + str(
    1 / FFGrading) + ' ' + str(1 / FFGrading) + ' ' + str(1 / FFGrading) + ' ' + str(1 / FFGrading) + ' 1 1 1 1) \n')
...
f.write('    hex (15 12 11 14 34 31 30 33) (' + str(NNE) + ' ' + str(NBL) + ' 1) edgeGrading (' + str(
...
f.write('    farfield\n')
f.write('    {\n')
f.write('        type patch;    // 纯粹的数学边界，没有任何几何性质\n')
f.write('        faces\n')
f.write('        (\n')
f.write('          (4 23 24 5)\n')
f.write('          (5 24 25 6)\n')
...
f.write('    airfoil\n')
f.write('    {\n')
f.write('        type wall;     // 壁面，可对其使用壁面函数\n')
f.write('        faces\n')
f.write('        (\n')
f.write('          (34 15 12 31)\n')
f.write('          (19 0 15 34)\n')
